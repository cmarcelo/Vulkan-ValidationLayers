...
class CoreChecks : public ValidationObject {
   public:
    ...
    void SetDisabledFlags(layer_data* instance_data, const VkValidationFlagsEXT* val_flags_struct);
    void SetValidationFeatures(layer_data* instance_data, const VkValidationFeaturesEXT* val_features_struct);
